...
public interface ItemFilter {
     ...
     * @param admin will be true if this item is currently listed in an admin shop, false if it's listed in a player shop
     * @return the ItemStack that the user will buy */
    ItemStack supply(int amount, boolean admin);
     ...
     * @param admin will be true if this item is currently listed in an admin shop, false if it's listed in a player shop
     */
    default void consume(ItemStack item, boolean admin) {}
    ...
    Optional<ItemStackSnapshot> getDisplayItem(boolean admin);
