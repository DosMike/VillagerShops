...
public class IncomeLimiterService {
    ...
    public void loadFromConfig(Map<UUID, BigDecimal> eaningValues, Map<UUID, BigDecimal> spendingValues, long timestamp) {
        earnings = eaningValues;
        spendings = spendingValues;
        serverDate = timestamp;
    }

    public Map<UUID, BigDecimal> getEarnings() {
        return earnings;
    }

    public Map<UUID, BigDecimal> getSpendings() {
        return spendings;
    }
